...
// Hàm thêm nhân viên
function add_employee($employees_firstname, $employees_lastname,$employees_dep, $employees_role)
{
    // Gọi tới biến toàn cục $conn
   global $conn;
    ...
    $sql = " INSERT INTO employees (first_name,last_name,department_id,role_id) VALUES
            ('$employees_firstname', '$employees_lastname',$employees_dep,$employees_role)";
...
// Hàm sửa nhân viên
function edit_employee($employees_id,$employees_firstname, $employees_lastname, $employees_dep,$employees_role)
{
    // Gọi tới biến toàn cục $conn
    global $conn;
    ...
    $sql = "
            ...
            first_name = '$employees_firstname',
            last_name= '$employees_lastname',
            department_id = $employees_dep,
            role_id=$employees_role
...
// Hàm xóa nhân viên
function delete_employee($employees_id)
{
    // Gọi tới biến toàn cục $conn
    global $conn;
    ...
    try{
     	 $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    // Câu SQL xóa
    $sql = " DELETE FROM employees WHERE employee_id = $employees_id ";
